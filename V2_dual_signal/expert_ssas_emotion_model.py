...
from V2_dual_signal.pmg_backbone import BrainGraphBackbone
...
class Stage1SSASSourceSelectionModel(nn.Module):
    ...
    def forward(
        ...
        enc_abs = self.shared_encoder(x_abs, de_feat=de_abs)
        enc_rel = self.shared_encoder(x_rel, de_feat=de_rel)
        z_abs = enc_abs["z"]
        z_rel = enc_rel["z"]
        z_emotion = z_rel
        z_diag_feat = z_abs
        ...
        out = {
                ...
                "z_abs": z_abs,
                "z_rel": z_rel,
                "z_conv_abs": enc_abs["z_conv"],
                "z_conv_rel": enc_rel["z_conv"],
                "z_pmg_abs": enc_abs["z_pmg"],
                "z_pmg_rel": enc_rel["z_pmg"],
                "z_bio_abs": enc_abs["z_bio"],
                "z_bio_rel": enc_rel["z_bio"],
                "plv_matrix_abs": enc_abs["plv_matrix"],
                "plv_matrix_rel": enc_rel["plv_matrix"],
                "region_adj_abs": enc_abs["region_adj"],
                "region_adj_rel": enc_rel["region_adj"],
                "region_embeddings_abs": enc_abs["region_embeddings"],
                "region_embeddings_rel": enc_rel["region_embeddings"],
