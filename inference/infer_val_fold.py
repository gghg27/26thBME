...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--folds_dir", type=Path, default=ROOT / "folds")
...
def main() -> None:
    ...
    fold_data = load_fold(args.repeat, args.fold, args.folds_dir)
    ...
    diag_df = filter_subjects(diag_df, fold_data["val_subjects"])
    emotion_df = filter_subjects(emotion_df, fold_data["val_subjects"])
